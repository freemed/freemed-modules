...
$display_buffer = "
	<div class=\"section\">".__("Inventory Reports")."</div><br/>
	<table cellspacing=\"0\" cellpadding=\"5\" width=\"100%\">
	<tr>
		<td>".module_function('ReconcileRep', 'viewrep_link')."</td>
	</tr>
	<tr>
		<td>".module_function('DispensingRep', 'viewrep_link')."</td>
	</tr>
	<tr>
		<td>".module_function('DoseplanRep', 'viewrep_link')."</td>
	</tr>
	<tr>
		<td>".module_function('DoseHoldRep', 'viewrep_link')."</td>
	</tr>	
	<tr>
		<td>".module_function('DoseHoldExcRep', 'viewrep_link')."</td>
	</tr>	
	<tr>
		<td>".module_function('DispenseRep', 'viewrep_link')."</td>
	</tr>
	<tr>
		<td>".module_function('DailyPostedOrder', 'viewrep_link')."</td>
	</tr>
	<tr>
		<td>".module_function('PendingOrder', 'viewrep_link')."</td>
	</tr>
	<tr>
		<td>".module_function('UsageByDay', 'viewrep_link')."</td>
	</tr>
	<tr>
		<td>".module_function('Labels', 'viewrep_link')."</td>
	</tr>
	</table>";
